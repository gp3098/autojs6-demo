...
(ui as any).tabs.addOnTabSelectedListener(
  new (com as any).google.android.material.tabs.TabLayout.OnTabSelectedListener({
...
(ui as any).taskList.on(
  "item_click",
  function (item: any, i: number, itemView: any, listView: any) {
